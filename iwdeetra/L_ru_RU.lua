uiStrings = {
	...
	ADD_SPELLS_TRIGGER_LABEL = "Добавление заклинаний в активацию",
	...
	ASSIGN_KEYS_PAGE_PRIESTSPELLS = "Заклинания жреца",
	ASSIGN_KEYS_PAGE_RETURNTOGAME = "Вернуться в игру",
	ASSIGN_KEYS_PRIESTSPELLS = "Заклинания жреца",
	...
	ASSIGN_KEYS_QUICKSLOTS_ITEMSLOT1 = "Предмет наготове 1",
	ASSIGN_KEYS_QUICKSLOTS_ITEMSLOT2 = "Предмет наготове 2",
	ASSIGN_KEYS_QUICKSLOTS_ITEMSLOT3 = "Предмет наготове 3",
	ASSIGN_KEYS_QUICKSLOTS_SELECTALL = "Выбрать всех",
	ASSIGN_KEYS_QUICKSLOTS_SPELLSLOT1 = "Заклинание наготове 1",
	ASSIGN_KEYS_QUICKSLOTS_SPELLSLOT2 = "Заклинание наготове 2",
	ASSIGN_KEYS_QUICKSLOTS_SPELLSLOT3 = "Заклинание наготове 3",
	ASSIGN_KEYS_QUICKSLOTS_WEAPONSLOT1 = "Оружие наготове 1",
	ASSIGN_KEYS_QUICKSLOTS_WEAPONSLOT2 = "Оружие наготове 2",
	ASSIGN_KEYS_QUICKSLOTS_WEAPONSLOT3 = "Оружие наготове 3",
	ASSIGN_KEYS_QUICKSLOTS_WEAPONSLOT4 = "Оружие наготове 4",
	...
	ENCHANTMENT_SCHOOL_TOKEN = "зачарования",
	...
	HELPTUTORIAL_PRIESTSPELLS = "Кнопка «Свиток жреца» выводит список заклинаний жреца выбранного персонажа и позволяет задать заклинания для запоминания.\n\nПримечание: эти заклинания будут доступны для произнесения только после отдыха.",
	HELPTUTORIAL_QUICKFORMATION = "Кнопки строя наготове заставляют членов отряда следовать нужному построению и порядку следования.",
	HELPTUTORIAL_QUICKITEM = "Ячейки предметов наготове соответствуют ячейкам предметов на странице снаряжения. Предметы из этих ячеек легко использовать во время боя, как и оружие наготове.\n\nПримечание: ячейки предметов наготове некоторых персонажей могут быть заняты драгоценностями или небольшими животными.",
	...
	HELPTUTORIAL_QUICKSPELLS = "Ячейки заклинаний наготове можно заполнять из списка запомненных заклинаний.",
	HELPTUTORIAL_QUICKWEAPON = "Ячейки оружия наготове соответствуют ячейкам оружия на странице снаряжения. После выбора оружия на экране снаряжения, оно появляется и в ячейках оружия наготове.",
	...
	HELPTUTORIAL_SWITCHTOCLERIC = "Кнопка переключения к заклинаниям жреца позволяет персонажам с доступом к заклинаниям обоих типов перейти к выбору заклинаний жреца.",
	...
	HELPTUTORIAL_TURNUNDEAD = "Режим изгнания нежити длится, пока не предпринято любое действие кроме перемещения. Клирики в этом режиме предпринимают попытки изгнания нежити, при успешной попытке нежить на время бежит прочь, а могущественным клириком может даже быть уничтожена. Злые жрецы используют эту способность для получения контроля над нежитью.",
	...
	SHOW_AOE_DESCRIPTION = "Отображать область охвата при использовании воздействующих на площадь заклинаний и предметов.",
	SHOW_AOE_LABEL = "Показ области охвата",
	...
	SPELL_MEMORIZATION_HELP = "Любой заклинатель (кроме колдунов и шаманов) должен запоминать заклинания, выбрав их в книге мага или свитке жреца и воспользовавшись затем кнопкой отдыха на левой панели.",
	...
	SPELL_TRIGGER_TITLE = "Активация заклинания",
