...
[Сборка 2.1](https://yadi.sk/d/7bniyRuu3T6Rr6), файл обновляется.
...
[Вариант для сборок с модами](https://disk.yandex.ru/d/nWHj27R7anqiSQ). Оформление списков в описаниях предметов, классов, заклинаний в этом варианте ближе к оригинальной игре и переводу большинства модов.
